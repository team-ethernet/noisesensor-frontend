...
function addData() {
    ...
    $.getJSON(`${APIURL}/data?startDate=${startTimestamp}&endDate=${endTimestamp}&minNoiseLevel=${mindB}&maxNoiseLevel=${maxdB}`).then(function (json) {
        insertData(json);
    });
}
...
function slideData() {
    ...
    $.getJSON(`${APIURL}/data?startDate=${newStartTimestamp}&endDate=${newEndTimestamp}&minNoiseLevel=${mindB}&maxNoiseLevel=${maxdB}`).then(function (json) {
        insertData(json);
    });
}
